  ...
  return (
    <main className="min-h-screen bg-[#FCFCF9] text-[#1A1A1A] font-sans">
      <div className="max-w-[680px] mx-auto px-6 py-16 md:py-24">
        ...
        <p className="text-lg leading-relaxed mb-4">
          You know your product is better than the competition. You&apos;ve seen theirs. The packaging is worse. The formulation is watered down. The build quality isn&apos;t close to yours. And yet — their Reels get 50k views and yours gets 400.
        </p>
        <p className="text-lg leading-relaxed mb-4">
        ...
        <div className="border-2 border-[#1A1A1A] p-6 md:p-8 mb-10">
          ...
          <div className="space-y-4 mb-6">
            <div className="border-l-4 border-[#1A1A1A] pl-4">
              ...
              <p className="text-sm text-[#555]">Your product as the star. Cinematic lighting, movement, detail shots. The one you pin to your Instagram and put on your landing page.</p>
            </div>
            <div className="border-l-4 border-[#1A1A1A] pl-4">
              <p className="font-bold text-base">2. The Lifestyle Spot (30 sec)</p>
              <p className="text-sm text-[#555]">Your product in context. Someone wearing it, using it, experiencing it. The &quot;I want that life&quot; video. Runs as your primary ad creative.</p>
            </div>
            <div className="border-l-4 border-[#1A1A1A] pl-4">
              <p className="font-bold text-base">3. The UGC Cut (30 sec)</p>
              <p className="text-sm text-[#555]">Styled like organic user-generated content — but beautifully shot. The &quot;my friend recommended this&quot; energy that converts on Reels. Feels authentic, looks expensive.</p>
            </div>
          </div>
        ...
        <div className="border-2 border-[#1A1A1A] p-5 mb-8">
          ...
          <p className="text-sm leading-relaxed text-[#555]">
            If the first draft of your Product Hero doesn&apos;t make you say &quot;whoa&quot; — we&apos;ll redo it. Twice. If after three attempts you&apos;re still not happy, full refund and keep the work. We&apos;re not interested in taking your money if we can&apos;t deliver something you&apos;re proud to post.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <a
            href="https://buy.stripe.com/test_niko-spec-79"
            target="_blank"
            className="block w-full text-center py-3 bg-[#1A1A1A] text-white font-bold text-base hover:bg-[#333] transition-colors"
          >
            Start with $79 Spec →
